...
class DDPM1D:
    ...
    def sample(self, shape):
        ...
        for i in reversed(range(self.n_T)):
            ...
            alpha_t = self._expand_time(
                x_t,
                self.alphas[t]
            )

            alpha_bar_t = self._expand_time(
                x_t,
                self.alphas_bar[t]
            )

            beta_t = self._expand_time(
                x_t,
                self.betas[t]
            )
    ...
    def ddim_denoise_signal(
        ...
        for i in range(len(time_steps) - 1):
            ...
            alpha_bar_next = alpha_bar_next.view(
                1, 1, 1
            )
